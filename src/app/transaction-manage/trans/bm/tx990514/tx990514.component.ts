...
const transCode = 'tx990514';
const transName = '微服务监控';
const tableName = '';
const exFuncCode = [];
...
@Component({
  selector: 'app-tx990514',
  templateUrl: './tx990514.component.html',
  styleUrls: ['./tx990514.component.css']
})
export class Tx990514Component extends BaseTransaction {
