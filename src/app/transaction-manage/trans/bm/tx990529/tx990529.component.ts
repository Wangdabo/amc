...
const transCode = 'tx990529';
const transName = '监控中心';
const tableName = '';
const exFuncCode = [];
...
@Component({
  selector: 'app-tx990529',
  templateUrl: './tx990529.component.html',
  styleUrls: ['./tx990529.component.css']
})
export class Tx990529Component extends BaseTransaction {
