...
const transCode = 'tx990519';
const transName = '链路追踪';
const tableName = '';
const exFuncCode = [];
...
@Component({
  selector: 'app-tx990519',
  templateUrl: './tx990519.component.html',
  styleUrls: ['./tx990519.component.css']
})
export class Tx990519Component extends BaseTransaction {
  ...
  onEnterAfter(): void {
    ...
    this.orbitUrl = this.ifearm.links;
